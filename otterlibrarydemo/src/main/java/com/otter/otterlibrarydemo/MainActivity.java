...
public class MainActivity extends AppCompatActivity {
    private static final String ACTION_DEMO_CODE = "com.otter.otterlibrarydemo.DEMO_CODE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView demo_item_list = (ListView) findViewById(R.id.demo_item_list);
        ...
        demo_item_list.setAdapter(adapter);
        demo_item_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
    ...
    private List<Map<String, Object>> getDemoItemList() {
        List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();

        // Search demo activities.
        Intent demoIntent = new Intent(ACTION_DEMO_CODE);
    ...
    private String getActivityTitle(ResolveInfo info) {
        ...
        // Remove the suffix "Demo".
        int index = lable.lastIndexOf("Demo");
        if (index > 0) {
